    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/') }}" class="brand-link">
                <img src="{{ asset('img/logo_blue.png') }}" alt="Logo" style="width: 150px;">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright © 2021 <a href="https://mcminn.no">Mcminn.no</a>.</strong> All rights reserved.
        </footer>
